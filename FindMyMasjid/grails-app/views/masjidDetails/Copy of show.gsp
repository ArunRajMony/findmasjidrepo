			...
			<ol class="property-list masjidDetails">
				...
				<li class="fieldcontain">
					<span id="prayer_1_TimingsHour-label" class="property-label"><g:message code="masjidDetails.prayer_1_TimingsHour.label" default="Prayer1 Timings Hour" /></span>
						...
						<span class="property-value" aria-labelledby="prayer_1_TimingsHour-label"><g:fieldValue bean="${masjidDetailsInstance}" field="prayer_1_TimingsHour"/>
						<b>:</b>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_1_TimingsMinutes"/>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_1_TimingsAMPM"/></span>
				...
				<li class="fieldcontain">
					<span id="prayer_2_TimingsHour-label" class="property-label"><g:message code="masjidDetails.prayer_2_TimingsHour.label" default="Prayer2 Timings Hour" /></span>
						...
						<span class="property-value" aria-labelledby="prayer_2_TimingsHour-label"><g:fieldValue bean="${masjidDetailsInstance}" field="prayer_2_TimingsHour"/>
						<b>:</b>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_2_TimingsMinutes"/>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_2_TimingsAMPM"/></span>					
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="prayer_3_TimingsHour-label" class="property-label"><g:message code="masjidDetails.prayer_3_TimingsHour.label" default="Prayer3 Timings Hour" /></span>
						...
						<span class="property-value" aria-labelledby="prayer_3_TimingsHour-label"><g:fieldValue bean="${masjidDetailsInstance}" field="prayer_3_TimingsHour"/>
						<b>:</b>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_3_TimingsMinutes"/>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_3_TimingsAMPM"/></span>
				...
				<li class="fieldcontain">
					<span id="prayer_4_TimingsHour-label" class="property-label"><g:message code="masjidDetails.prayer_4_TimingsHour.label" default="Prayer4 Timings Hour" /></span>
						...
						<span class="property-value" aria-labelledby="prayer_4_TimingsHour-label"><g:fieldValue bean="${masjidDetailsInstance}" field="prayer_4_TimingsHour"/>
						<b>:</b>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_4_TimingsMinutes"/>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_4_TimingsAMPM"/></span>
				...
				<li class="fieldcontain">
					<span id="prayer_5_TimingsHour-label" class="property-label"><g:message code="masjidDetails.prayer_5_TimingsHour.label" default="Prayer5 Timings Hour" /></span>
						...
						<span class="property-value" aria-labelledby="prayer_5_TimingsHour-label"><g:fieldValue bean="${masjidDetailsInstance}" field="prayer_5_TimingsHour"/>
						<b>:</b>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_5_TimingsMinutes"/>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_5_TimingsAMPM"/></span>
				...
				<li class="fieldcontain">
					<span id="prayer_FridayNoon_TimingsHour-label" class="property-label"><g:message code="masjidDetails.prayer_FridayNoon_TimingsHour.label" default="Prayer Friday Noon Timings Hour" /></span>
						...
						<span class="property-value" aria-labelledby="prayer_FridayNoon_TimingsHour-label"><g:fieldValue bean="${masjidDetailsInstance}" field="prayer_FridayNoon_TimingsHour"/>
						<b>:</b>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_FridayNoon_TimingsMinutes"/>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_FridayNoon_TimingsAMPM"/></span>
				...
				<li class="fieldcontain">
					<span id="prayer_jummah_TimingsHour-label" class="property-label"><g:message code="masjidDetails.prayer_jummah_TimingsHour.label" default="Prayerjummah Timings Hour" /></span>
						...
						<span class="property-value" aria-labelledby="prayer_jummah_TimingsHour-label"><g:fieldValue bean="${masjidDetailsInstance}" field="prayer_jummah_TimingsHour"/>
						<b>:</b>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_jummah_TimingsMinutes"/>
						<g:fieldValue bean="${masjidDetailsInstance}" field="prayer_jummah_TimingsAMPM"/></span>
